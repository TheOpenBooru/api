from . import router
from modules import database, schemas, account
from modules.dependencies import DecodeToken
...
async def get_profile(account:account.Account = Depends(DecodeToken)):
