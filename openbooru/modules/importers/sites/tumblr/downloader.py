from openbooru.modules import schemas, settings, posts, normalise
from openbooru.modules.importers import Downloader, DownloadFailure, utils
...
async def post_from_data(data:dict[str,Any]) -> list[schemas.Post]:
    ...
    tags = normalise.normalise_tags(data['tags'])
    if data["type"] == "photo":
        posts = []
