...
| `importers.hydrus.access_key`                     | The hydrus access key to be used                                                                                                          | `ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff` |                                         |
| `importers.hydrus.url`                            | The hydrus endpoint url to be used                                                                                                        | `http://localhost:45869`, `https://192.168.0.22`                   | `http://localhost:45869/`               |
| `importers.hydrus.tags`                           | The tag searches to be used                                                                                                               | `system:everything`, `system:limit is 64`                          | `system:everything`                     |
...
| `downloaders.tubmlr.consumer_key`                 | The consumer key to be used                                                                                                               | `FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF`               |                                         |
| `downloaders.tubmlr.consumer_secret`              | The consumer secret to be used                                                                                                            | `FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF`               |                                         |
